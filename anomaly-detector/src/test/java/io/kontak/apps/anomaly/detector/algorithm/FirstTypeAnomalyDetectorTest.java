...
import io.kontak.apps.anomaly.detector.algorithm.FirstTypeAnomalyDetector;
...
public class FirstTypeAnomalyDetectorTest {
    ...
    void shouldNotFoundAnomaly() {
        FirstTypeAnomalyDetector detector = new FirstTypeAnomalyDetector();
    ...
    @Test
    void shouldNotFoundAnomalyWhenNotEnoughReadings() {
        FirstTypeAnomalyDetector detector = new FirstTypeAnomalyDetector();
        Optional<Anomaly> result = detector.apply(List.of(reading1, reading2, reading12));
        assertThat(result.isPresent()).isEqualTo(false);
    }
    ...
    void shouldFoundAnomalyOnlyForOneThermometer() {
        ...
        Optional<Anomaly> result = detector.apply(List.of(reading1, reading2, reading3, reading4, reading5, reading6, reading7, reading8, reading9, reading11));
        Optional<Anomaly> result2 = detector.apply(List.of(reading12));
        Optional<Anomaly> result3 = detector.apply(List.of(reading13));
